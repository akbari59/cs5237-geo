...
public:
   std::vector<std::array<LongInt, 4>> set;
	...
	void getPlaneNorm(int p1Idx, int p2Idx, int p3Idx, array<LongInt, 3>& norm) const;
	...
	int inCircle(int p1Idx, int p2Idx, int p3Idx, int pIdx) const;// return 1 if the point p is inside the circumcircle of p1p2p3
